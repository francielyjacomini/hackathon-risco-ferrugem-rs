...
ui <- page_sidebar(
  ...
  sidebar = sidebar(
    ...
    helpText("A modelação matemática de severidade segue a equação polinomial oficial do esquema metodológico, ajustada para a época de semeadura escolhida.")
  ),
    ...
    nav_panel(
      ...
      card(
        ...
        **2. A Engrenagem Matemática:**
        A severidade da doença na lavoura segue a modelação empírica baseada na precipitação acumulada na janela crítica. Aplicámos a equação de regressão calibrada para o modelo:
        ...
        * **Risco Inerente Bruto:** O modelo não contabiliza a eficácia do controlo químico (uso de fungicidas) pelo produtor ou a adoção de cultivares resistentes. O painel projeta o **pior cenário ambiental (risco puro)**, ideal para precificação de apólices e auditoria de campo.
